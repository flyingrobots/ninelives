...
- [ ] [P1.04](P1.04.md) Implement basic sinks:
- [ ] [P1.04.a](P1.04.a.md) Implement basic sinks:
- [ ] [P1.04.b](P1.04.b.md) Implement basic sinks:
- [ ] [P1.05](P1.05.md) Wire policies to accept telemetry sink via `.with_sink()` method
...
- [ ] [P1.06](P1.06.md) Implement `MulticastSink` for sending to multiple sinks (multicast to both)
...
- [ ] [P1.07](P1.07.md) Implement `FallbackSink` for fallback on failure
...
- [ ] [P1.08](P1.08.md) Add `ComposedSinkError` type for composition errors
...
- [ ] [P1.10](P1.10.md) Thread sink through policy constructors/builders via `.with_sink()` method
...
- [ ] [P1.11](P1.11.md) Add examples showing telemetry integration:
...
- [ ] [P1.12](P1.12.md) Benchmark overhead of event emission (deferred to Phase 10)
